<template>
  <div class="changemessage">
    ...
    <el-dialog title="知识信息" :visible.sync="dialogFormVisible" class="modify-message">
      <el-form label-width="100px">
        <el-form-item label="图片" :label-width="formLabelWidth">
          <img :src="$store.state.imgShowRoad + '/file/' + cupdateKnowledgeInfo.picture"
            alt="" class="order-img"/>
          <el-upload
      ...
      <el-form :model="form">
        ...
        <el-form-item label="知识内容" :label-width="formLabelWidth">
  ...
  methods: {
    ...
    handleSuccess(response, file, fileList) {
      if (file.response.flag == true) {
        ...
        this.cupdateKnowledgeInfo.picture = file.response.data;
    ...
    changeMessageClick() {
      ...
      updateKnowledgeById({
        ...
        picPath: this.cupdateKnowledgeInfo.picture,
      })
        .then((res) => {
          if (res.flag == true) {
            this.reload();
